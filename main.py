...
def place_order(category, product_key, quantity, link):
    ...
    # คำนวณยอดเงินหลังจากหัก
    remaining_balance = balance - total_price
    print(f"ยอดเงินหลังจากหัก: {remaining_balance} บาท 💳")

    # แสดงยอดเงินหลังจากหักด้วยตัวคูณ
    adjusted_remaining_balance = round(remaining_balance * BALANCE_MULTIPLIER, 2)
    print(f"ยอดเงินที่เหลือหลังจากหัก (พร้อมตัวคูณ): {adjusted_remaining_balance} บาท 💳")
    ...
    try:
        ...
        if response_order.status_code == 200:
            ...
            if 'order' in order_data:
                ...
                print(f"ยอดเงินที่เหลือหลังจากการสั่งซื้อ: {remaining_balance} บาท 💳")
                print(f"ยอดเงินที่เหลือหลังจากการสั่งซื้อ (พร้อมตัวคูณ): {adjusted_remaining_balance} บาท 💳")
            else:
